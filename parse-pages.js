...
try {
  glob(`./src/assets/pages/**/*.md`, (err, files) => {
    ...
    fs.writeFileSync('./src/app/shared/pages-metas.ts', 'import {PageMeta} from \'./page-meta\';\n' +
      '\nexport const pagesMetas: PageMeta[] = ');
    fs.appendFileSync('./src/app/shared/pages-metas.ts', util.inspect(pages, false, 2, false));
